...
API_ID = int(environ.get('API_ID', '24602732'))
API_HASH = environ.get('API_HASH','9d8e8c1693826086a3d0b75e85afb840')
BOT_TOKEN = environ.get('BOT_TOKEN','7962035532:AAHbYyzK72Q6JS3EfUwtuxZ50JcuRl-RO74')
PORT = environ.get('PORT', '8082')

# Owners 
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5672857559').split()]
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'II_YOUR_GOJO_ll') # without @ or https://t.me/ 
